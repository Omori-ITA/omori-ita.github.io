...
function text_array(lang) {
    ...
    eng_array = [
        ...
        "The console versions (Switch, PS4 and XBox) and the Gamepass version " +
        "are not compatible with the translation. We apologise for the inconvenience.",
